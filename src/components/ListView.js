      ...
      return (
          <Card key={facility.Prop_ID} style={{backgroundColor: 'rgb(245, 203, 92)', marginLeft: 10, marginRight: 10, alignItems: 'center', justifyItems: 'center'}}>                 
            <View style={{flexDirection: 'column', alignItems: 'center', justifyItems: 'center', marginTop: 10}}>
              ...
              <Text style={{fontFamily: 'Brother1816Printed-Black', fontSize: 18}}>{facility.Name}</Text>
              <Text style={{fontFamily: 'Brother1816Printed-Regular', marginBottom: 8}}>{facility.Location}</Text>
              <View style={{flexDirection: 'row'}}>
                <Button style={{backgroundColor: 'black', marginRight: 10}}  onPress={() => { this.renderEventsView()}}>
                ...
                <Button style={{backgroundColor: 'black', marginBottom: 10}} onPress={() => { this.navigateToFacility('http://maps.apple.com/?saddr=' + this.props.userLatitude + ',' + this.props.userLongitude + '&daddr=' + + this.props.markers.lat + ',' + this.props.markers.lon)}}>
